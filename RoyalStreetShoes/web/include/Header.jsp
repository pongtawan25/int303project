                ...
                <div class="col-sm-5 col-md-3">
                    <form action="Search" class="search-wrap">
                        <div class="form-group">
                            <input name="search" type="search" class="form-control search" placeholder="Search">
            ...
            <div class="row">
                <div class="col-sm-12 text-left menu-1">
                    <ul>
                        ...
                        <li class="cart"><a href="Cart"><i class="icon-shopping-cart"></i> Cart[${cart.totalQuantity}]</a></li>
                            <c:choose>
